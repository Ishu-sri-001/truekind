...
const SecondPage = () => {
  ...
  return (
    <div className="pt-20 h-fit pb-10 overflow-y-hidden overflow-x-hidden relative">
      <div className="py-[4vh] ml-16 flex">
        <div>

        <h2 className="text-[3.5vw] leading-[1.2] tracking-wider font-body font-semibold text-neutral-700 second-heading-container">
          <div className="h-fit w-fit overflow-hidden pt-2">
            <span className="inline-block animated-txt2">
          ...
          <span className="inline-block text-[3.5vw] font-body font-semibold text-neutral-700 max-w-lg second2">PERFORMANCE</span>
        </div>
        </h2>
        ...
        <div className="flex mt-5">
          ...
          <h2 className="text-6xl text-neutral-700 italic font-display underline font-light second3">
            skincare.
          </h2>
          </div>
        </div>
          ...
          <Image
            ...
            />
                ...
                <div className="h-fit rounded-[1.5vw] w-[17vw] bg-neutral-100 absolute top-[50%] left-[5%] py-10 flex flex-col  justify-center items-center card-1 moving-elements px-4 ">
                    <div className="pt-5 p-3 rounded-full bg-white w-[6vw] h-fit "><Image src='/assets/svg/icon-clean-beyond-reproach.svg' height={700} width={700} alt='leaf'/></div>
                     <div className="w-[80%] mx-2 flex flex-col  text-neutral-700 font-body">
                      ...
                      <p className="text-[0.8vw] mt-4 text-center">Truly clean with only verified ingredients; and free from over 1800 questionable ingredients. Because what you put on your skin matters.</p>
                  </div>
                </div>

                <div id='card2' className="h-fit rounded-[1.5vw] w-[17vw] py-10 bg-neutral-100 absolute top-[25%] left-[25%] flex flex-col card-2 justify-center items-center moving-elements px-4">
                     ...
                     <div className="w-[80%] mx-2 flex flex-col text-neutral-700 font-body">
                      ...
                      <p className="text-[0.8vw] mt-4 text-center">No black boxes, nothing to hide, we disclose our full formulas, so you will never have to guess what's in it and how much.</p>
                     </div>
                </div>

                <div id='card3' className="h-fit rounded-[1.5vw] w-[17vw] absolute right-90 -bottom-[25%] bg-neutral-100 mt-[650px] py-10 flex flex-col justify-center items-center card-3 moving-elements px-4">
                  <div className="mt-5 p-3 rounded-full bg-white w-[6vw] h-fit "><Image src='/assets/svg/icon-potent-multi-tasking.svg' height={700} width={700} alt='leaf'/></div>
                     <div className="w-[80%] mx-2 flex flex-col text-neutral-700 font-body">
                      ...
                      <p className="text-[0.8vw] mt-4 text-center">Our formulas are chock-a-block with actives, anti oxidants, skin restoring agents backed by dermal science that aim to deliver real results.</p>
                  </div>
                </div>

                <div id='card4' className="h-fit rounded-[1.5vw] w-[17vw] absolute bottom-right-100 -bottom-[2%] right-30 bg-neutral-100 mt-[450px] py-10 flex flex-col justify-center items-center card-4 moving-elements px-4">
                  <div className="mt-5 p-3 rounded-full bg-white w-[6vw] h-fit "><Image src='/assets/svg/icon-conscious-responsible.svg' height={700} width={700} alt='leaf'/></div>
                     <div className="w-[80%] mx-2 flex flex-col font-body text-neutral-700">
                      ...
                      <p className="text-[0.8vw] mt-4 text-center font-light">Peta Certified Vegan and Cruelty Free. Our products are always housed in responsible packaging and made sustainably.</p>
                  </div>
                </div>
